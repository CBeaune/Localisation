...
c=0;
troissigmax = zeros(size(t)); %ajouté par Audrey
...
for i=1:length(t)
    ...
    troissigmax(i)=3*sigmaXmeasurement; %ajouté par Audrey
    
end
plot( t,troissigmax,'k', 'LineWidth',1 );
hold on;
plot( t,-troissigmax,'k', 'LineWidth',1 );
hold on;
...
subplot(3,1,2);
plot( t,3*sigmaYmeasurement,'k', 'LineWidth',1 );
hold on;
plot( t,-3*sigmaYmeasurement,'k', 'LineWidth',1 );
hold on;
